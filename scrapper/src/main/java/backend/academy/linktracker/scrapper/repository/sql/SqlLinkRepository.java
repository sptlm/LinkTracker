...
public class SqlLinkRepository implements LinkRepository {
    ...
    @Override
    public long nextId() {
        Long id = jdbcClient.sql("select nextval('tracked_link_id_seq')").query(Long.class).single();
        if (id == null) {
    ...
    public Optional<TrackedLink> findById(long id) {
        return jdbcClient.sql("select * from tracked_link where id = :id")
                .param("id", id)
    ...
    public List<TrackedLink> findAllById(List<Long> ids) {
        ...
        return jdbcClient.sql("select * from tracked_link where id in (:ids)")
                .param("ids", ids)
                .query(LINK_ROW_MAPPER)
                .list()
                .stream()
    ...
    public Optional<TrackedLink> findByUrl(String url) {
        return jdbcClient.sql("select * from tracked_link where url = :url")
                .param("url", url)
                .query(LINK_ROW_MAPPER)
                .optional();
    }
    ...
    public List<TrackedLink> findAll() {
        return jdbcClient.sql("select * from tracked_link order by id")
                .query(LINK_ROW_MAPPER)
                .list();
    }
    ...
    public List<TrackedLink> findPage(long offset, int limit) {
        return jdbcClient.sql("select * from tracked_link order by id limit :limit offset :offset")
                .param("limit", limit)
                .param("offset", offset)
                .query(LINK_ROW_MAPPER)
                .list();
    ...
    public void deleteById(long id) {
        jdbcClient.sql("delete from tracked_link where id = :id").param("id", id).update();
    }
